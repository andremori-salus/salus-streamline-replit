...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
      ...
      <div className="absolute top-20 right-0 w-[600px] h-[600px] bg-yellow-500/10 rounded-full blur-[100px] -z-10" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Button size="lg" className="h-14 px-8 rounded-full text-base bg-yellow-500 hover:bg-yellow-600 text-black font-bold shadow-[0_0_20px_rgba(234,179,8,0.3)]">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-card/50 backdrop-blur-sm group">
               <div className="absolute inset-0 bg-gradient-to-tr from-yellow-500/10 to-amber-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
               <img 
                 src={generatedImage} 
                 alt="Salus Dashboard Interface" 
                 className="w-full h-auto object-cover opacity-90 hover:scale-105 transition-transform duration-700 sepia-[.5] hue-rotate-[15deg] saturate-[.8]"
               />
               ...
               >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-mono text-sm text-yellow-400">System Secure</span>
                  </div>
